<div>
    <ul class="nav nav-tabs nav-justified">
        ...
        <li class="nav-item"><a href="{{ route('users.advices_favorites', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/advices_favorites') ? 'active' : '' }}">いいねしたアドバイス <span class="badge badge-secondary">{{ $count_advices_favorites }}</span></a></li>
    </ul>    
</div>